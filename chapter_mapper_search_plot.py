...
Original file is located at
    https://colab.research.google.com/drive/1AqMUttHIDf9NijpvPbEIPIP-x8i_LgKe
"""
...
if len(search_query) > 0:
  print(answer_query_with_context(search_query, df, COMPLETIONS_MODEL=COMPLETIONS_MODEL, EMBEDDING_MODEL=EMBEDDING_MODEL))
